        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    IssuedpayDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipSuccecs = table.Column<bool>(type: "bit", nullable: false),
                    Succescfull = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNew = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_ProductPromotions_ProductPromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportInvoices_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartImports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CartImports_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CartImports_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartImports_ApplicationUserId",
                table: "CartImports",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CartImports_ProductId",
                table: "CartImports",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportInvoices_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductPromotionId",
                table: "Products",
